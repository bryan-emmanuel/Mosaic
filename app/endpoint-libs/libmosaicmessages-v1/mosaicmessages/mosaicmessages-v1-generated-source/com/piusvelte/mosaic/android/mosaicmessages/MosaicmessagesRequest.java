...
public abstract class MosaicmessagesRequest<T> extends AbstractGoogleJsonClientRequest<T> {
   ...
   */
  public MosaicmessagesRequest(
      Mosaicmessages client, String method, String uriTemplate, Object content, Class<T> responseClass) {
    super(
        client,
        method,
        uriTemplate,
 ...
 */
  ...
  @Override
  public final Mosaicmessages getAbstractGoogleClient() {
    return (Mosaicmessages) super.getAbstractGoogleClient();
  }

  @Override
  public MosaicmessagesRequest<T> setDisableGZipContent(boolean disableGZipContent) {
    return (MosaicmessagesRequest<T>) super.setDisableGZipContent(disableGZipContent);
  }

  @Override
  public MosaicmessagesRequest<T> setRequestHeaders(HttpHeaders headers) {
    return (MosaicmessagesRequest<T>) super.setRequestHeaders(headers);
  }
}
