...
public abstract class MosaicusersRequest<T> extends AbstractGoogleJsonClientRequest<T> {
  ...
  /** Data format for the response. */
  public MosaicusersRequest<T> setAlt(java.lang.String alt) {
    this.alt = alt;
    return this;
  }
  ...
  /** Selector specifying which fields to include in a partial response. */
  public MosaicusersRequest<T> setFields(java.lang.String fields) {
    this.fields = fields;
    return this;
  }
 ...
 * reports. Required unless you provide an OAuth 2.0 token.
 */
  public MosaicusersRequest<T> setKey(java.lang.String key) {
    this.key = key;
    return this;
  }
  ...
  /** OAuth 2.0 token for the current user. */
  public MosaicusersRequest<T> setOauthToken(java.lang.String oauthToken) {
  ...
  /** Returns response with indentations and line breaks. */
  public MosaicusersRequest<T> setPrettyPrint(java.lang.Boolean prettyPrint) {
 ...
 * assigned to a user, but should not exceed 40 characters. Overrides userIp if both are provided.
 */
  public MosaicusersRequest<T> setQuotaUser(java.lang.String quotaUser) {
 ...
 * limits.
 */
  public MosaicusersRequest<T> setUserIp(java.lang.String userIp) {
    this.userIp = userIp;
    return this;
  }
