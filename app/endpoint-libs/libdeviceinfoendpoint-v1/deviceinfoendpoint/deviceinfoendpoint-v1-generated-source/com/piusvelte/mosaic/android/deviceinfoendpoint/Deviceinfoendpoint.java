 ...
 *  on 2013-02-11 at 01:49:44 UTC 
 */

package com.piusvelte.mosaic.android.deviceinfoendpoint;
...
public class Deviceinfoendpoint extends AbstractGoogleJsonClient {
  ...
  public class GetDeviceInfo extends DeviceinfoendpointRequest<com.piusvelte.mosaic.android.deviceinfoendpoint.model.DeviceInfo> {
    ...
    protected GetDeviceInfo(String id) {
      super(Deviceinfoendpoint.this, "GET", REST_PATH, null, com.piusvelte.mosaic.android.deviceinfoendpoint.model.DeviceInfo.class);
   ...
   * operation.
   *
   * @param content the {@link com.piusvelte.mosaic.android.deviceinfoendpoint.model.DeviceInfo}
   * @return the request
   */
  public InsertDeviceInfo insertDeviceInfo(com.piusvelte.mosaic.android.deviceinfoendpoint.model.DeviceInfo content) throws java.io.IOException {
    InsertDeviceInfo result = new InsertDeviceInfo(content);
    initialize(result);
    return result;
  }

  public class InsertDeviceInfo extends DeviceinfoendpointRequest<com.piusvelte.mosaic.android.deviceinfoendpoint.model.DeviceInfo> {
     ...
     * @since 1.13
     */
    protected InsertDeviceInfo(com.piusvelte.mosaic.android.deviceinfoendpoint.model.DeviceInfo content) {
      super(Deviceinfoendpoint.this, "POST", REST_PATH, content, com.piusvelte.mosaic.android.deviceinfoendpoint.model.DeviceInfo.class);
    }
  ...
  public class ListDeviceInfo extends DeviceinfoendpointRequest<com.piusvelte.mosaic.android.deviceinfoendpoint.model.DeviceInfoCollection> {
    ...
    protected ListDeviceInfo() {
      super(Deviceinfoendpoint.this, "GET", REST_PATH, null, com.piusvelte.mosaic.android.deviceinfoendpoint.model.DeviceInfoCollection.class);
    }
  ...
  public class RemoveDeviceInfo extends DeviceinfoendpointRequest<com.piusvelte.mosaic.android.deviceinfoendpoint.model.DeviceInfo> {
    ...
    protected RemoveDeviceInfo(String id) {
      super(Deviceinfoendpoint.this, "DELETE", REST_PATH, null, com.piusvelte.mosaic.android.deviceinfoendpoint.model.DeviceInfo.class);
      this.id = Preconditions.checkNotNull(id, "Required parameter id must be specified.");
    }
   ...
   * @return the request
   */
  public UpdateDeviceInfo updateDeviceInfo(com.piusvelte.mosaic.android.deviceinfoendpoint.model.DeviceInfo content) throws java.io.IOException {
    UpdateDeviceInfo result = new UpdateDeviceInfo(content);
    initialize(result);
    return result;
  }

  public class UpdateDeviceInfo extends DeviceinfoendpointRequest<com.piusvelte.mosaic.android.deviceinfoendpoint.model.DeviceInfo> {
     ...
     * @since 1.13
     */
    protected UpdateDeviceInfo(com.piusvelte.mosaic.android.deviceinfoendpoint.model.DeviceInfo content) {
      super(Deviceinfoendpoint.this, "PUT", REST_PATH, content, com.piusvelte.mosaic.android.deviceinfoendpoint.model.DeviceInfo.class);
    }
