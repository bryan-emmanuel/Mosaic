...
public class HttpClientManager {
	...
	public static String httpResponse(Context context, HttpUriRequest httpRequest) {
		DefaultHttpClient httpClient = HttpClientManager.getThreadSafeClient(context);
